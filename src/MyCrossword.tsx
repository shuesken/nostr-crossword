...
import { crosswordProviderPropTypes } from "@jaredreisinger/react-crossword/dist/CrosswordProvider";
 ...
 * functionality.
 */
const MyCrossword = React.forwardRef<CrosswordImperative, CrosswordProps>(
...
MyCrossword.displayName = "Crossword";
MyCrossword.propTypes = crosswordPropTypes;
MyCrossword.defaultProps = {
